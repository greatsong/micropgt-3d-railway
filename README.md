...
> **당곡고 · 신림고 · 수도여고 공유 캠퍼스 연합 동아리**를 위한 실시간 다중접속 AI 학습 게임 플랫폼
...
| 변수 | 값 | 필수 여부 |
|------|-----|-----------|
| `TEACHER_PASSWORD` | 원하는 비밀번호 | **필수** (Railway Variables에서 반드시 설정) |
...
| `TEACHER_PASSWORD` | *(환경변수 필수 설정)* | 교사 대시보드 인증 비밀번호 |
