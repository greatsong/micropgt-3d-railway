...
function NeuralNetDemo({ weights, onWeightChange, showBackward, showError }) {
    ...
    return (
        <div className={styles.neuralNetCenter}>
            <canvas
                ref={canvasRef}
                width={480}
                height={300}
                className={styles.neuralNetCanvas}
            />
            {showError && (
                <div
        ...
        switch (step.id) {
                ...
                return (
                    <div className={styles.welcomeBox}>
                        ...
                        <p className={styles.text}>
                            사람이 시험에서 <strong className={styles.colorRed}>틀린 문제</strong>를 보고 배우듯,<br />
                            AI도 <strong className={styles.colorGreen}>틀려야 배웁니다!</strong><br /><br />
                            이 과정이 궁금하지 않나요?
                        </p>
                        ...
                        <p className={styles.textWithMargin}>
                            이 과정을 <strong className={styles.colorPurple}>역전파(Backpropagation)</strong>라 합니다!
                        </p>
                    </div>
                );
                ...
                return (
                    <div className={styles.dsContainer}>
                        <p className={styles.instruction}>
                            순전파: 입력이 <strong className={styles.colorBlue}>앞으로</strong> 흘러가며 출력을 만드는 과정!<br />
                            보라색 선의 굵기 = 가중치의 크기
                        </p>
            ...
            case 'error':
                return (
                    <div className={styles.dsContainer}>
                        <p className={styles.instruction}>
                            출력(Y)과 <strong className={styles.colorGreen}>정답(0.8)</strong>의 차이 = <strong className={styles.colorRed}>오차!</strong>
                        </p>
                        <NeuralNetDemo weights={weights} showBackward={false} showError={true} />
                        <div className={styles.metaphorBoxTop}>
                            <div className={styles.metaphorItem}>
                                <span className={styles.emoji15}>🎯</span>
                                <p>정답: <strong>0.8</strong></p>
                            </div>
                            <span className={styles.arrowSepSmall}>−</span>
                            <div className={styles.metaphorItem}>
                                <span className={styles.emoji15}>🤖</span>
                            ...
                            <span className={styles.arrowSepSmall}>=</span>
                            <div className={styles.metaphorItemError}>
                                <span className={styles.emoji15}>📏</span>
                                <p className={styles.colorRed}><strong>오차!</strong></p>
                            </div>
                        </div>
                    </div>
                );
            ...
            case 'backward':
                return (
                    <div className={styles.dsContainer}>
                        <p className={styles.instruction}>
                            역전파: 오차를 <strong className={styles.colorRed}>뒤로 거슬러</strong> 각 가중치에 전달!<br />
                            빨간 화살표 = 오차 신호의 역방향 흐름
                        </p>
                        <NeuralNetDemo weights={weights} showBackward={true} showError={true} />
                        <div className={styles.hintBoxTop}>
                            <div className={styles.hintItem}>
                                <span className={styles.hintItemForward}>➡️ 순전파</span>
                                <p>입력 → 출력</p>
                            </div>
                            <div className={styles.hintItem}>
                                <span className={styles.hintItemBackward}>🔄 역전파</span>
                                <p>오차 → 가중치 수정</p>
                            </div>
                        </div>
                        <p className={styles.hintMarginTop}>
            ...
            case 'adjust':
                return (
                    <div className={styles.dsContainer}>
                        <p className={styles.instruction}>
                            🎛️ <strong>직접</strong> 6개 가중치를 조절해서 오차를 <strong className={styles.colorGreen}>0.05 이하</strong>로 만들어보세요!
                        </p>
                        ...
                        <div className={styles.sliderGrid}>
                            {weights.map((w, i) => (
                                <div key={i} className={styles.sliderRow}>
                                    <span className={styles.sliderLabel}>w{i + 1}</span>
                                    <input
                                        type="range"
                ...
                return (
                    <div className={styles.labContainer}>
                        ...
                        <p className={styles.text}>
                            ...
                            역전파 과정을 <strong className={styles.colorYellow}>단계별로 시각화</strong>하고<br />
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.header}>
                <span className={styles.weekBadge}>7주차</span>
